...
DIR_OF_THIRD_PARTY = os.path.join( DIR_OF_THIS_SCRIPT, './bindings/python' )
...
# for clang-llvm lib  (apt installed)
    '-isystem',
    '/usr/lib/llvm-7/include/c++/v1',
    '-isystem',
    '/usr/include/clang/7.0.1/include',

# binary install; does't work
    # '-isystem',
    # '~/ycm_tmp/llvm_root_dir/include/c++/v1',
    # '-isystem',
    # '~/ycm_tmp/llvm_root_dir/include/clang',
